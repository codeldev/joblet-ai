...
return [
    ...
    'section.general.1.answer'           => ':app is an AI-powered web application that helps users create professional, customized job cover letters. The application uses advanced AI technology to generate cover letters tailored to your specific situation, job role, and preferences.',
    'section.general.2.question'         => 'How does :app work?',
    'section.general.2.answer.1'         => 'You simply enter your name, role applying for, select your preferred language variant and date format, and customize AI settings like creativity level, tone, and length. You’ll also need to upload your latest resume/CV',
    'section.general.2.answer.2'         => 'You can also add optional content such as reasons for leaving, transition assistance offers, expressions of gratitude, and positive experiences. The AI then generates a professionally written cover letter based on your inputs.',
    'section.general.3.question'         => 'How many cover letters can I create?',
    'section.general.3.answer.1'         => 'New users receive 2 free credits upon signup, which allows you to generate two cover letters to try out the service. After that, you can purchase additional credits through my Standard package (5 letter generation attempts) or Extended package (15 letter generation attempts).',
    ...
    'section.account.1.answer.2'         => 'The signup process takes less than 30 seconds to complete. All I need is your name, email address, and a password. Once registered, you’re immediately logged in and can start generating your cover letter right away. There’s no email verification delay or complicated setup process.',
    ...
    'section.generation.1.answer.list.2' => 'Title of the job applied for',
    ...
    'section.generation.3.answer.list.1' => 'Reason for leaving (with specific details)',
    'section.generation.3.answer.list.2' => 'Offer of transition assistance',
    'section.generation.3.answer.list.3' => 'Expressions of gratitude',
    'section.generation.3.answer.list.4' => 'Mention of positive experiences (with specific details)',
