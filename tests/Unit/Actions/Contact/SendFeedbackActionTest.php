...
beforeEach(closure: function (): void
{
    ...
    $this->action = new SendFeedbackAction;

    Notification::fake();
});

describe(description: 'Send Feedback Message Action', tests: function (): void
{
    test(description: 'stores message and sends email on success', closure: function (): void
    {
        ...
        $this->action->handle(
            ...
            success  : fn () => expect(value: true)->toBeTrue(),
            failed   : fn () => null,
        );
        ...
        Notification::assertSentTo(
            ...
            notification: FeedbackMessageNotification::class,
            callback    : fn (FeedbackMessageNotification $notification) => $notification->feedbackData === $this->validated
        );
    });

    test(description: 'returns error on database failure', closure: function (): void
    {
