<flux:modal
    ...
    variant="flyout"
    position="right"
    class="w-full max-w-sm sm:max-w-md md:max-w-3xl !p-6 lg:!p-8 shadow-lg"
>
    <div class="space-y-6 small-description">
        <div>
            <flux:heading
                size="xl"
                class="flex items-center gap-2"
            >
                <flux:icon.cog class="size-8" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-3 md:gap-y-4 gap-x-6">
            <flux:textarea
